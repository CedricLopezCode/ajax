...
//*********************************************************************
//*********************************************************************
	//Version jQuery refaite depuis 0
//Exo 4: Affichage Galerie 


$(".miniatures").each(function(index){
	$(".miniatures")[index].addEventListener("click",echange_src_js);
});

function echange_src_html(miniature_selectionnee){
	$("#grande_image").attr("src", miniature_selectionnee.getAttribute("src"));
}
function echange_src_js(){
	$("#grande_image").attr( "src", $(this).attr("src") );
}
